 ...
 */
class Jahr3Nummer extends Auftrag implements iReNr {

	function getLabel(){
		return "JahrNummer, z.B. 2008001";
	}
	
	public static function getNextNumber($type){
		$jahr = date("Y");
		$startNumber = $re_nr = $jahr."001";
		...
		$re_nr2 = $re_nr."";
		if($jahr > $re_nr2{0}.$re_nr2{1}.$re_nr2{2}.$re_nr2{3}) $re_nr = $startNumber;
		return $re_nr;
	}
}
?>
